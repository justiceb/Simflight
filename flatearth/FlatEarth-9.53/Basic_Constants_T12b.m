...
AR_h = 4;                        % Aspect ratio of the horizontal tail
AR_w = 6.67;              % Aspect ratio of the wing
b_f = 13/12;                 % Span of the flap [ft] (Alieron total span)****
b_h = 12/12;                   % Span of the horizontal tail [ft]
b_h_oe = 8/12;                % Elevator outboard position [ft]
b_h_ie = 0;                  % Elevator inboard position [ft]
b_w = 70/12;                  % Span of the wing [ft]
b_v = 5/12;                  % Vertical tail span measured from fuselage centerline[ft]
b_v_or = 5/12;                  % Outboard position of rudder [ft]
b_v_ir = 0;                     % Inboard position of rudder [ft]
c_a = 3/12;                   % Chord of aileron [ft]
C_bar_D_o = 0.015;       % Parasite drag
Cd_0 = 0.015;               % Drag coefficient at zero lift (parasite drag)
c_e = 1/12;                         % Elevator chord [ft]
...
c_r =  1/12;                 % MEAN Chord of the rudder [ft]
c_w = 10.5/12;                 % Mean aerodynamic chord of the wing [ft]
c_v = 3/12;                   % Mean aerodynamic chord of the vertical tail [ft]
D_p = 10/12;          % Diameter of propeller [ft]
d = 6/12;                                % Average diameter of the fuselage [ft]
...
S_h = 36/144;                    % Area of horizontal tail [ft^2]
S_h_slip = 30/144;                % Area of horizontal tail that is covered in 
%                                                prop-wash [ft^2] - See Fig.(8.64) - Ref.(3) ***EST
S_o = 40/144;                    % Fuselage x-sectional area at Xo [ft^2] - 
%                                                See Fig.(7.2) - Ref.(2)
%                                                 Xo is determined by plugging X1/l_b into: 
%                                                0.378 + 0.527 * (X1/l_b) = (Xo/l_b)
S_w = 735/144;          % Surface area of wing [ft^2]
S_v = 30/144;               % Surface area of vertical tail [ft^2]
...
Xach = 100/12;            % Distance from the leading edge of the wing mean aerodynamic chord
